...
public abstract class AbstractDoubleProblem extends AbstractGenericProblem<MyDefaultDoubleSolution>
    {
 ...
 // @Override
  ...
  //@Override
  public MyDefaultDoubleSolution createSolution() {
    return new MyDefaultDoubleSolution(bounds, getNumberOfObjectives(), getNumberOfConstraints());
  }
