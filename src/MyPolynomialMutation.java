...
public class MyPolynomialMutation implements MutationOperator<MyDefaultDoubleSolution> {
  ...
  public double[] execute2(double[] x, double[] lowerBound, double[] upperBound) {
    double rnd, delta1, delta2, mutPow, deltaq;
    double y, yl, yu, val, xy;

    //double distrib_index = (double) solution.getAttribute("mutpar") * (25 - 1) + 1;
    // Antes distrib_index = distributionIndex
    double distrib_index = 0;
