...
public class OrigNSGAII<S extends Solution<?>> extends AbstractGeneticAlgorithm<S, List<S>> {
   ...
   * Constructor
   */
  public OrigNSGAII(Problem<S> problem, int maxEvaluations, int populationSize,
