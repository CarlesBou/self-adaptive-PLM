...
public class OrigPolynomialMutation implements MutationOperator<MyDefaultDoubleSolution> {
  ...
  /** Constructor */
  public OrigPolynomialMutation() {
    this(DEFAULT_PROBABILITY, DEFAULT_DISTRIBUTION_INDEX);
  }

  /** Constructor */
  public OrigPolynomialMutation(DoubleProblem problem, double distributionIndex) {
  ...
  /** Constructor */
  public OrigPolynomialMutation(double mutationProbability, double distributionIndex) {
